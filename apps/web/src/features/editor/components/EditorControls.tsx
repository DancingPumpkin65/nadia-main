...
function getDescription() {
  switch (snapshotStep) {
    case 9:
      return "Upload an image, render it to canvas locally, and export the result.";
    case 10:
      return "Compare blur and pixelate masking modes with a fixed preview mask before auto-detection.";
    case 11:
      return "Use MediaPipe and BlazeFace locally in the browser before applying blur or pixelation.";
    case 12:
      return "Detector fallback and clearer status messaging make the masking flow easier to trust.";
    case 13:
      return "Multi-scale browser passes improve detection on smaller and harder faces.";
    case 14:
      return "When auto-detect misses, drag over the face on the original preview to add a manual fallback.";
    case 15:
      return "Add an auto-sized text rectangle overlay before exporting the rendered result.";
    default:
      return "Add an auto-sized text rectangle overlay and drag it directly on the rendered canvas.";
  }
}
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) => onUpdateState({ textPadding: Number(event.target.value) || 18 })}
                />
              </div>
            </div>
